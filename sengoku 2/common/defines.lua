...
NTechnology = {
	...
	IDEAL_YEAR_LEVEL_0 = 1466, --the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 1853,
	...
	REN_PROVINCE        = 327, -- Province where the Renaissance is centered
